-- ====================================================================
-- SAKHI SOLO FEMALE TRAVEL PLATFORM - PRODUCTION SUPABASE SCHEMA
-- Includes Auth Integration, Performance Indexes, RLS Policies & Vector Search
-- ====================================================================
...
-- 1. USERS PROFILE TABLE (References auth.users)
...
-- 2. DESTINATIONS TABLE (Static Destination Info Only - Dynamic Financial/Weather Data Removed)
...
-- 3. DESTINATION AREAS TABLE (Neighbourhood Safety & Micro Metrics)
...
-- 5. ACCOMMODATIONS TABLE (Normalized Foreign Key to destination_areas)
...
-- 10. PLACES OF INTEREST TABLE (Normalized Foreign Key to destination_areas)
...
-- 12. CHAT CONVERSATIONS & MESSAGES (Extended with tool_used & context_snapshot)
...
-- 14. ARRIVAL SESSIONS TABLE (Extended with transport_used, route_type, arrival_success)
...
-- 16. RECOMMENDATIONS TABLE (Extended with reasoning_json)
...
-- 17. RECOMMENDATION SOURCES TABLE
...
-- 18. KNOWLEDGE DOCUMENTS TABLE (Normalized Foreign Key to destinations)
...
-- ====================================================================
-- PGVECTOR COSINE SIMILARITY INDEX FOR FAST RAG SEARCH
-- ====================================================================
...
-- Enable RLS across user and private data tables
...
-- 1. Users Profile Policy: Users can only read/update their own profile
CREATE POLICY "Users access own profile" ON public.users FOR ALL USING (auth.uid() = id);

-- 2. Trips Policy: Users can access their own trips
CREATE POLICY "Users access own trips" ON public.trips FOR ALL USING (auth.uid() = user_id);

-- 3. Travel Pack Policy: Users access travel packs for their trips
...
-- 7. Public Catalogue Access Policies (Publicly readable for all users)
...
-- ====================================================================
-- SEED BASELINE DATA (European Cities & Knowledge Documents)
-- ====================================================================
